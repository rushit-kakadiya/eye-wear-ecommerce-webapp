...
import List from '../../../../views/products/frame/name/List';
import { fetchFrameNames } from '../../../../redux/products/action';
...
export default (props) => {
    ...
    useEffect(()  => {
        if(props.type ==  "summary"){
            dispatch(fetchFrameNames({ page: state.page, search: state.search }));
        }
