...
export default ({ handleEditOthers, products }) => {
    ...
    return (
        <Form onSubmit={handleSubmit(handleEditOthers)}>
                    ...
                    <Col md="12" sm="12" className="summary-section">
                        ...
                        <Row>
                            <Col md='6' sm="12" xs="12" style={{ marginTop: "25px" }}>
                                <FormGroup>
                                    <Button type="button" disabled={is_loading} onClick={() => reset()} color="danger" outline={true} style={{ width: "100%" }}>Cancel</Button>
                                </FormGroup>
                            </Col>
                            <Col md='6' sm="12" xs="12" style={{ marginTop: "25px" }}>
                                <FormGroup>
