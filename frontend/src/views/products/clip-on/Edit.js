...
export default ({ loading, handleEditClipOn, products }) => {
    ...
    const { register, handleSubmit, errors, control, reset, setValue } = useForm({ 
        defaultValues : {
            ...
            frame_sku : product_detail.frame_sku,
    ...
    return (
        <Form onSubmit={handleSubmit(handleEditClipOn)}>
                    ...
                    <Col md="12" sm="12" className="summary-section">
                        ...
                        <Row>
                            <Col md='6' sm="12" xs="12" style={{ marginTop: "25px" }}>
                                <FormGroup>
                                    <Button type="button" disabled={loading} onClick={() => resetForm()} color="danger" outline={true} style={{ width: "100%" }}>Reset</Button>
                                </FormGroup>
                            </Col>
                            <Col md='6' sm="12" xs="12" style={{ marginTop: "25px" }}>
                                <FormGroup>
