                    ...
                    {loading ? 'loading...' : <>
                        <Col md="12" sm="12">
                            <Row>
                                ...
                                <Col md="6" className='summary-section-item-head'> Lense Type Name  </Col>
                                <Col md="6" className="summary-section-item-value"> {detail && detail.lense_type_name}   </Col>
                                <Col md="6" className='summary-section-item-head'> Prescription Name  </Col>
                                <Col md="6" className="summary-section-item-value"> {detail && detail.prescription_name}   </Col>
                                <Col md="6" className='summary-section-item-head'> Index Value  </Col>
                                <Col md="6" className="summary-section-item-value"> {detail && detail.index_value}   </Col>
                                <Col md="6" className='summary-section-item-head'> Category Name  </Col>
                                <Col md="6" className="summary-section-item-value"> {detail && detail.category_name}   </Col>
                                <Col md="6" className='summary-section-item-head'> Filter Type Name  </Col>
                                <Col md="6" className="summary-section-item-value"> {detail.filter_type_name || '----'}   </Col>
