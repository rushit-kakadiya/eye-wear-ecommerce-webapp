...
const schedule = '*/5 * * * *';
let cron_code = 'turboly_order_complete_update';
  ...
  try {
    ...
    const response = await utils.axiosClient({
      ...
      params: {
        ...
        status: constants.turboly_order_status.ORDER_COMPLETED
      },
      data: {},
    });
    ...
    let replacements = {
      order_status: constants.order_status.ORDER_DELIVERED,
      workflow_state: constants.turboly_order_status.ORDER_COMPLETED,
      current_status: constants.order_status.ORDER_SHIPPED
    };
