...
const schedule = '*/5 * * * *';
let cron_code = 'turboly_ready_to_delivery';
  ...
  try {
    ...
    const response = await utils.axiosClient({
      ...
      params: {
        ...
        status: constants.turboly_order_status.ORDER_READY_FOR_DELIVERY
      },
      data: {},
    });
    ...
    let replacements = {
      order_status: constants.order_status.ORDER_READY_FOR_DELIVERY,
      workflow_state: constants.turboly_order_status.ORDER_READY_FOR_DELIVERY,
      current_status: constants.order_status.ORDER_CONFIRMED
    };
