...
const schedule = '*/5 * * * *';
let cron_code = 'turboly_store_pick_up';
  ...
  try {
    ...
    const response = await utils.axiosClient({
      ...
      params: {
        ...
        status: constants.turboly_order_status.ORDER_READY_FOR_COLLECT
      },
      data: {},
    });
    ...
    let replacements = {
      order_status: constants.order_status.ORDER_READY_FOR_COLLECT,
      workflow_state: constants.turboly_order_status.ORDER_READY_FOR_COLLECT,
